...
3. Plan safe changes.
4. Modify the document using this skill's DOCX delivery workflow and `scripts/docx/` helpers.
...
- Prefer Microsoft Word automation or a manual Word/PDF review for layout-sensitive changes.
